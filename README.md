...
> Some Qualities & Codecs Need Special Driver / Hardware to get maximum output i always recommend to use `HI_RES` or `LOSSLESS` both are flac.
...
- 📀 AUDIO QUALITY / CODEC  : SONY_360RA | DOLBY ATMOS | MQA 96K  | HI RES FLAC | FLAC LOSSLESS | HIGH | LOW | Up to 24-bit, 192 kHz
