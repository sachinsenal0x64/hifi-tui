...
I love terminal/CLI tools as well as musics, so why not to have a tidal music client for the terminal? Unfortunately, I haven't found any client for tidal in the terminal yet, and that's why it's all about :)
